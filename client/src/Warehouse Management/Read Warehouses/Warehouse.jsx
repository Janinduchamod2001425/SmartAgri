...
const Warehouse = () => {
    ...
    useEffect(() => {
        const fetchWarehouses = async () => {
            try {
                const response = await axios.get("http://localhost:8000/WarehouseRoutes/getWarehouses");
    ...
    const deleteWarehouse = async (warehouseId) => {
        try {
            ...
            const response = await axios.delete(`http://localhost:8000/WarehouseRoutes/deleteWarehouse/${warehouseId}`);
